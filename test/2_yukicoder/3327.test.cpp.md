...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/3327
    links:
    - https://yukicoder.me/problems/no/3327
  bundledCode: "#line 1 \"test/2_yukicoder/3327.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/3327\"\
    ...
    \        }\n};\n#line 3 \"test/2_yukicoder/3327.test.cpp\"\n#include <bits/stdc++.h>\n\
    using namespace std;\n\nvoid solve() {\n        int N, Q;\n        cin >> N >>\
    \ Q;\n        vector<int> A(N);\n        for (auto &x : A) cin >> x;\n       \
    ...
    \     while (Q--) {\n                int c, x;\n                cin >> c >> x;\n\
    \                if (c == 1) {\n                        int pos = seg.find_first(0,\
    \ N - 1, [&](const int &val) { return val > x; });\n                        if\
    \ (pos != -1) {\n                                seg.update(pos, -1);\n      \
    \                          pos++;\n                        }\n               \
    \         cout << pos << '\\n';\n                } else {\n                  \
    ...
    \       cin.tie(NULL);\n\n        int t = 1;\n        // cin >> t;\n        while\
    \ (t--) solve();\n\n        return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/3327\"\n#include \"ds/segtree/segtree.hpp\"\
    \n#include <bits/stdc++.h>\nusing namespace std;\n\nvoid solve() {\n        int\
    \ N, Q;\n        cin >> N >> Q;\n        vector<int> A(N);\n        for (auto\
    \ &x : A) cin >> x;\n        struct Monoid {\n                using value_type\
    ...
    \   SegTree<Monoid> seg(A);\n        while (Q--) {\n                int c, x;\n\
    \                cin >> c >> x;\n                if (c == 1) {\n             \
    \           int pos = seg.find_first(0, N - 1, [&](const int &val) { return val\
    \ > x; });\n                        if (pos != -1) {\n                       \
    \         seg.update(pos, -1);\n                                pos++;\n     \
    \                   }\n                        cout << pos << '\\n';\n       \
    \         } else {\n                        int pos = seg.find_last(0, N - 1,\
    \ [&](const int &val) { return val > x; });\n                        if (pos !=\
    \ -1) {\n                                seg.update(pos, -1);\n              \
    \                  pos++;\n                        }\n                       \
    \ cout << pos << '\\n';\n                }\n        }\n}\n\nint main() {\n   \
    \     ios::sync_with_stdio(false);\n        cin.tie(NULL);\n\n        int t =\
  ...
  requiredBy: []
  timestamp: '2026-01-22 20:49:26+07:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/2_yukicoder/3327.test.cpp
layout: document
redirect_from:
- /verify/test/2_yukicoder/3327.test.cpp
- /verify/test/2_yukicoder/3327.test.cpp.html
